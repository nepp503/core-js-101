...
function timeSpanToString(startDate, endDate) {
  ...
  const minutes = Math.floor((diff - hours * (1000 * 60 * 60)) / 60000);
  const seconds = Math.floor((diff - hours * (1000 * 60 * 60) - minutes * 60000) / 1000);
  let ms = diff - hours * (1000 * 60 * 60) - minutes * 60000 - seconds * 1000;
  if (ms < 10) {
    ms = `00${ms}`;
